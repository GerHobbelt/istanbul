...
/*global espree, escodegen, window */
(function (isNode) {
    "use strict";
    var SYNTAX,
        nodeType,
        ESP = isNode ? require('espree') : espree,
    ...
    /**
     * mechanism to instrument code for coverage. It uses the `espree` and
     ...
     * ------------------
     *
     * Load `espree.js`, `escodegen.js` and `instrumenter.js` (this file) using `script` tags or other means.
     *
